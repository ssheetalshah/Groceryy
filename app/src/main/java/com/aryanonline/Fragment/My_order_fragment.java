...
import com.aryanonline.Adapter.My_order_adapter;
...
public class My_order_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(com.aryanonline.R.layout.fragment_my_order, container, false);

        ((MainActivity) getActivity()).setTitle(getResources().getString(com.aryanonline.R.string.my_order));
