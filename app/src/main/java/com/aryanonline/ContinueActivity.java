...
public class ContinueActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnReg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             Intent intent = new Intent(ContinueActivity.this,RegisterActivity.class);
    ...
    class SendJsonDataToServer extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... arg0) {
                ...
                String result = Utilities.postParamsAndfindJSON("http://aryanonline.co.in/aryan-store/index.php/Api/signup", urlParameters);
                return result;
        }
        ...
        protected void onPostExecute(String result) {
            if (result != null) {
                ...
                try {
                    ...
                    if (!s.equals("true")) {
                        Toast.makeText(ContinueActivity.this, "USer Not Found!", Toast.LENGTH_SHORT).show();
                    } else {
