...
public class NCardAdapter extends RecyclerView.Adapter<NCardAdapter.ProductHolder> {
    ...
    public NCardAdapter(Activity activity, ArrayList<HashMap<String, String>> list) {
        this.list = list;
    ...
    @Override
    public NCardAdapter.ProductHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = null;

        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.nitem, parent, false);

        return new NCardAdapter.ProductHolder(view);
    }


    @Override
    public void onBindViewHolder(final NCardAdapter.ProductHolder holder, final int position) {
